...
//condicionales que verifican que el usuario y clave agregados si se encuentren en la base de datos
...
//mensajes de error sino se cumple alguno de los condicionales
        if (empty($usuario)) {
